...
const About = () => {
  return (
    <section className='about section' id='about'> {/* Main section container with id 'about' */}
        ...
        <div className='about__container container grid'> {/* Container for about section content */}
            ...
            I’m a tech enthusiast with a foundational understanding of Full Stack Web Development, Machine Learning, Data Science, AI, Deep Learning, and UI/UX Design. I enjoy building basic web applications and exploring intelligent systems, combining creativity with emerging technologies. I’m eager to learn more and apply innovative ideas to solve real-world challenges through thoughtful design and automation.            </p>
            <a download="" href={CV} className='button button--flex'> {/* Link to download CV */}
                Download CV {/* Link text */}
                <svg
                className="button__icon" /* SVG icon for the button */
              ...
              >
                ...
                <path
                  ...
                  fill="var(--container-color)" /* Fill color for the icon */
                ></path>
                {/* Additional SVG paths for the icon */}
                <path
                ...
                <path
                  ...
                  fill="var(--container-color)0" /* Fill color for the icon */
                ></path>
                <path
